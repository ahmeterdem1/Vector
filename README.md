...
Improvements on type-checking.

Some ML operations like softmax are added to Vector class.

ReLU function added.

Frobenius product added to Matrix class.
...
### Vectorgebra.Vector.randVgauss(dim, mu, sigma, decimal=True)
...
### Vectorgebra.Matrix.randMgauss(m, n, mu, sigma, decimal=True)
