...
class Vector:
    ...
    def randVfloat(dim: int, a: float, b: float, decimal: bool = True):
    ...
    def randVbool(dim: int, decimal: bool = True):
...
class Matrix:
    ...
    def randMint(m: int, n: int, a: int, b: int, decimal: bool = True):
        if m <= 0 or n <= 0:
            raise RangeError()
        v = list()
        if decimal:
            for k in range(0, m):
                temp = list()
                for l in range(0, n):
                    temp.append(Decimal(random.randint(a, b)))
                v.append(Vector(*temp))
        else:
            for k in range(0, m):
                temp = list()
    ...
    def randMfloat(m: int, n: int, a: float, b: float, decimal: bool = True):
        if m <= 0 or n <= 0:
            raise RangeError()
        v = list()
        if decimal:
            for k in range(0, m):
                temp = list()
                for l in range(0, n):
                    temp.append(Decimal(random.uniform(a, b)))
                v.append(Vector(*temp))
        else:
            for k in range(0, m):
                temp = list()
    ...
    def randMbool(m: int, n: int, decimal: bool = True):
        if m <= 0 or n <= 0:
            raise RangeError()
        v = list()
        if decimal:
            for k in range(0, m):
                temp = list()
                for l in range(0, n):
                    temp.append(Decimal(random.randint(0, 1)))
                v.append(Vector(*temp))
        else:
            for k in range(0, m):
                temp = list()
